...
public class MainActivity extends AppCompatActivity {
    int channelProfile;
    public static final String channelMessage = "com.pk.videocalleasy.CHANNEL";
    public static final String profileMessage = "com.pk.videocalleasy.PROFILE";
